...
# ----------------------------------
PROJECT_ID = 'wagon-bootcamp-322821'  # Name of the project in GCP account ex: 'wagon-bootcamp-323012'
BUCKET_NAME = 'reestimator'  # Name of the bucker in GCP account ex: 'wagon-data-662-gilard'
